  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;BOBIZA;;;\nFN:BOT\nORG:abdsamad\nTITLE:\nitem1.TEL;waid=212605784394:212605784394\nitem1.X-ABLabel:abdsamad\nX-WA-BIZ-DESCRIPTION:[❗] contact abdsamad___75\nEND:VCARD`;
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Warning*', body: 'BOBIZABOT', thumbnail: imagen1, sourceUrl: 'https://instagram.com/abdsamad___75'}}}}, aa);
